...
def cli():
    parser = argparse.ArgumentParser(prog='GraphMiner', \
                                     description='...',\
                                     epilog='...')
    parser.add_argument("-i", "--input", type=str, default=True, help="input file SMILES and groups, should be a csv file", required=True)
    ...
    parser.add_argument("-o", "--outputsubstr", type=str, help="Name of the output file containing all substructures")
    ...
    parser.add_argument('-sel', '--SelectionMethod', type=str, choices=['MoleculeSize', 'TimeOutTimer'], default='TimeOutTimer', \
