...
def mol_substr_bfs2(selected_mol, all_substr, dict_substr, total_molecules):
    print(' ')
    repl = {}
    sel_smile = Chem.MolToSmiles(selected_mol, kekuleSmiles = True)
    sel_mol = Chem.MolFromSmiles(sel_smile)
            ...
            for mol_smile in list_of_smiles:
                ...
                if selected_mol == None:
                    ...
                    for mol in selected_mol:
                        dict_substr, group_tot, all_substr = mol_substr_bfs2(
                            Chem.MolFromSmiles(mol), all_substr,
                            dict_substr, group_tot)
